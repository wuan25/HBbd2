const contentLetterSrart_actived = "Hello huỳn ngu nhe."; //Lời mở đầu cho bức thư
const mainContentLetter =
  "Cảm ơn người anh em đã ở bên tôi suốt thời gian qua,chúc em tuổi mới luôn xinh đẹp,luôn hạnh phúc,yêu em rất nhiều"; //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/huyen.jpg";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/huyen.jpg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
